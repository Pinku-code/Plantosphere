  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto text-center mb-10">
        ...
        <p className="text-md sm:text-lg text-green-700 dark:text-green-300">
          Shop our sustainable offerings: Kitchen Garden Kits, Organic Spices, Ice Apple Juice, Multi-Grain Flour, and Health Supplements.
          Bulk supply available for jute, maize, and chilies.
        </p>
      </div>
