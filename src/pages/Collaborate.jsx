  ...
  return (
    ...
    <div className="bg-white text-gray-800 dark:bg-black dark:text-gray-200 mt-14">
      ...
      <div className="bg-white dark:bg-black py-12 text-center">
        <h1 className="text-4xl font-bold text-green-800 dark:text-green-500">Collaborate with Us</h1>
      ...
      <div className="bg-green-50 dark:bg-gray-900 py-12 px-6 text-center">
        <h2 className="text-2xl font-semibold text-green-800 dark:text-green-500 mb-4">How to Collaborate</h2>
      ...
      <div className="max-w-4xl mx-auto text-center py-12 px-6">
        ...
        <a
          href="/contact"
          className="inline-block bg-white border border-green-700 text-md font-bold text-green-700 px-6 py-3 rounded hover:bg-green-50"
        >
          Contact Us
        </a>
      </div>
